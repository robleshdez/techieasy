...
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/ClosureContext.php');
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/ClosureScope.php');
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/ClosureStream.php');
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/ISecurityProvider.php');
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/ReflectionClosure.php');
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/SecurityException.php');
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/SecurityProvider.php');
require_once realpath(ABSPATH . 'public/vendor/PHPAsync/opis_closure/SelfReference.php');
/**
...
class SerializableClosure //implements Serializable
{
    ...
    public function __serialize():array
    {
        ...
        if (static::$securityProvider !== null) {
            $data = static::$securityProvider->sign($state);
            $state = [
            'signed' => true,
            'hash' => $data['hash'],
    ...
    public function __unserialize(array $data): void
{
    ...
    if (!is_array($this->code)) {
        throw new SecurityException('Invalid serialized closure structure.');
    }
